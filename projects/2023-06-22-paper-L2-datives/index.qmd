...
- **Overall preference**: 71% of all dative constructions were realized as ditransitives, consistent across all groups including native speakers.
- **Cross-linguistic differences**: Chinese speakers used significantly more prepositional datives than other groups, while German speakers showed an even stronger preference for ditransitives than native speakers.
- **Length effects**: All learner groups struggled with making native-like choices when the length difference between recipient and patient was close to zero. When clear length cues were present (e.g., a much longer recipient), learners made more target-like choices.
- **Interaction effects**: Chinese and German speakers showed opposite behaviors when length differences were minimal -- Chinese speakers underused ditransitives while German speakers overused them. Spanish speakers fell somewhere in between.

These findings support the notion that learners from different L1 backgrounds are differentially sensitive to the discourse and information-structural cues that govern the dative alternation in English, which has implications for L2 instruction and materials development.
