...
The takeaway? Learners from different language backgrounds pick up on different cues when deciding how to phrase things in English. This matters for teaching -- what works for one group of learners might not work for another.
